/*
  This version of the speedometer_v2 uses less SRAM. This is just here for testing.
  For example if I ever needed more SRAM while adding new features.
*/
...
U8G2_PCD8544_84X48_1_4W_HW_SPI nokia(U8G2_R2, /* cs=*/4, /* dc=*/3, /* reset=*/5);  // Nokia 5110 Display
